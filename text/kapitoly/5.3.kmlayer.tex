...
Neurony Kohonenovy mapy pøi uèení souteí o to, kterı z nich bude aktivní pøi daném vstupu.
...
Síla odpudivosti je parametr modelu, urèující, jak moc se budou uzly odpuzovat.
\end{definition}


Vzájemná odpudivost dvou uzlù závisí na síle odpudivosti, vzdálenosti uzlù a jejich naplnìnosti.
...
Vısledek testu je na obrázku \ref{fig:kml-ag}\footnote{Další vısledky testù s rùznou hodnotou síly odpudivosti jsou na pøiloeném CD, jsou obdobné}.
