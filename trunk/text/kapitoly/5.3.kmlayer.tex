...
\begin{figure}[h!]
  ...
  \caption{Poèáteèní pokrytí svìta uzly uspoøádanımi do ètvercové møíky.}
  \label{fig:kml-start}
\end{figure}
...
Tím jsme pøevedli pùvodní problém hledání oblastí s vyšším poètem pøedmìtù na problém opaènı, tj. na hledání bez pøedmìtù.
Øešení s pouitím umìlıch pøedmìtù tedy nevyhovuje.
\\
