...
Navrhli jsme tedy model vrstvy uzlù zaloenı na Kohonenovì mapì - Kohonen Map Layer.
\\
...
\begin{algorithm}[h!]
\caption{Zpracování vjemu v Kohonen Map Layer}
\label{alg:km-uceni}
\begin{algorithmic}[1]
...
Tímto algoritmem se uzly Kohonen Map Layer v prùbìhu uèení/vnímání pøibliují k objektùm.
\\
...
je souèet intenzit všech jeho vazeb na pamìové stopy. Pøedstavuje míru dùleitosti uzlu pro pamì na pøedmìty.
