...
Model prostorové mapy popsaný v kapitole \ref{chapter-model} resp. \ref{chapter-model-el} jsme implementovali v prototypové aplikace v jazyce Python.
...
\item knihovny PIL\footnote{Python Imaging Library}, NumPy\footnote{pro nástroj \texttt{plotter.py}\label{fn:repeat}} a Matplotlib\footref{fn:repeat}
...
Aplikace vytvoøí adresáø \texttt{../../tests/yyyy-mm-dd--hh-mm-ss/} a spustí postupnì všechny dostupné testy.
...
Rychlost aplikace závisí pøedevším na poètu uzlù prostorové mapy. Ve svìtech s vìtším poètem uzlù trvá 1 krok simulace pøibližne 1 sekundu.
\footnote{Na PC 2.4GHz 4GB RAM, Windows Vista.}
\\
